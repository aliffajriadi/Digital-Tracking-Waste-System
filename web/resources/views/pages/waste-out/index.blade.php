...
<div class="max-w-7xl mx-auto space-y-5">
    ...
    <form method="GET" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-wrap items-center gap-3">
        ...
        <a href="{{ route('admin.waste-out.index') }}" class="h-9 px-4 border border-gray-200 text-gray-500 text-xs font-bold rounded-xl hover:bg-gray-50 flex items-center">Reset</a>
        @endif
    </form>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50/60 transition-colors">
                    ...
                    <td class="px-6 py-4 text-xs text-gray-600">{{ $item->destination?->name ?? $item->wasteDestination?->name ?? '-' }}</td>
